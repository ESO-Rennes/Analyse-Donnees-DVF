...
date: "02/07/2021 - Mise à jour 14/10/2025"
output:
  html_document:
    toc: true
    toc_float:
...
# Partitionnement de l'objet sf avec les indices créés (création d'un objet de type 'list')
...
Selection_Communes <- Communes[Communes$NOM_COM %in% liste_noms, ]
...
mf_map(x = Communes,
       type = "prop",
          ...
          leg_title = "Nombre de mutations \nDVF par commune", leg_pos = "bottomleft")
...
mf_title("Nombre de mutations par commune en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
Communes <- Communes %>% 
  mutate(NbMaisons = lengths(st_intersects(Communes, Maisons))) %>% 
  mutate(NbAppart = lengths(st_intersects(Communes, Appartements)))
```
...
mf_map(x = Communes,
       type = "prop",
          ...
          lwd = 0.01, # épaisseur du contour des cercles
          leg_title = "Ventes de maisons \npar commune", leg_pos = "bottomleft")

# Ajouter les étiquettes des communes sélectionnées plus haut
mf_label(Selection_Communes, var = "NOM_COM", halo = TRUE, bg = "white", r = 0.05, cex = 0.7, pos = 3, font = 4, offset = 0)

# Habillage de la carte
mf_title("Nombre de ventes de maisons par commune en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
# Habillage de la carte
mf_title("Nombre de ventes d'appartements par commune en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
# Habillage de la carte
mf_title("Prix moyen au m² des mutations, par commune en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
# Habillage de la carte
mf_title("Prix nominal moyen des mutations par commune en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
setDT(DVFgeobis)  # Convertir le dataframe en data.table
...
# Habillage de la carte
mf_title("Prix moyen au m² des mutations par maille de 2 km en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
CommunesBZHDVF <- Communes[!row.names(Communes) %in% Iles, ]
...
print(moran.test(CommunesBZHDVF$Prixm2Moyen, 
...
# Habillage de la carte
mf_title("Prix moyen au m² de l'immobilier par commune en Bretagne entre 2014 et 2019", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
print(moran.test(DVFgeo$prixm2, 
                 listw = nb2listw(PPV)))
...
# Récupération de l'indice du point de la grille le plus proche de chaque mutation
...
emprise <- as.owin(st_bbox(depBZH))
...
id_ppv <- setDT(id_ppv)
setnames(id_ppv, c("dist", "id_grid")) # renommage des colonnes
...
# Habillage de la carte
mf_title("Prix moyen au m² de l'immobilier en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")

mf_scale()

mf_arrow(pos = "topright", adj = c(-1,-3))
...
# Habillage de la carte
mf_title("Nombre de transactions immobilières en Bretagne entre 2014 et 2019", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
# Habillage de la carte
mf_title("Nombre de transactions immobilières par maille de 25 ha. en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
# Habillage de la carte
mf_title("Prix au m² et mutations par EPCI en Bretagne (2014-2019)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")
...
CommunesDVFClassif1 <- as.data.frame(Communes) %>%
  select(INSEE_COM, 
         NbMutations, 
         PrixMoyen, 
         Prixm2Moyen)
...
```{r tableau synthese}
RecapCAHRegion <- CommunesCluster %>% 
  group_by(CLUSIMMO) %>% 
  summarise(
  Nbcommunes = n(), 
...
SyntheseCAHRegion <- RecapCAHRegion %>% 
  mutate(
...
# Habillage de la carte
mf_title("Sous-marchés immobiliers issus de la CAH (Bretagne)", cex = 0.8, tab = TRUE, fg = "white", bg = "black", line = 1, pos = "left")

...
date: '02/07/2021 - Mise à jour 17/10/2023'
output:
  word_document:
    toc: yes
...
layoutLayer(title = "Prix moyen au m² de l'immobilier par Iris dans Rennes Métropole (2014-2019)", source = "         IGN et DGFip", 
...
labelLayer(Selection_Communes_RM, txt = "NOM_COM", halo = TRUE, bg = "white", r = 0.05, cex = 0.6, pos = 3, font = 3, offset = 0, overlap = TRUE)
...
layoutLayer(title = "Nombre de mutations par Iris dans Rennes Métropole (2014-2019)", source = "         IGN et DGFip", north = TRUE, horiz = FALSE, tabtitle = TRUE, frame = FALSE, col = "#cdd2d4", coltitle = "#8A5543")
...
layoutLayer(title = "Prix moyen au m² de l'immobilier par section cadastrale dans Rennes Métropole (2014-2019)", source = "         IGN et DGFip", 
            north = TRUE, horiz = FALSE, tabtitle = TRUE,
            frame = FALSE, col = "#cdd2d4", coltitle = "#8A5543")
...
layoutLayer(title = "Nombre de mutations par section cadastrale dans Rennes Métropole (2014-2019)", source = "         IGN et DGFip", north = TRUE, horiz = FALSE, tabtitle = TRUE, frame = FALSE, col = "#cdd2d4", coltitle = "#8A5543")
...
labelLayer(Selection_Communes_RM, txt = "NOM_COM", halo = TRUE, bg = "white", r = 0.05, cex = 0.6, pos = 3, font = 3, offset = 0)
```
...
layoutLayer(title = "Prix moyen au m² de l'immobilier dans Rennes Métropole (2014-2019)", 
            author = "         Sources : IGN, DGFip - Rayon : 1000 m\n         résolution : 1 ha - A partir des sections cadastrales", 
            scale = 5, frame = TRUE, col = "#cdd2d4", coltitle = "#8A5543", 
            north = TRUE, tabtitle = TRUE, horiz = FALSE)
...
cartelissee <- Smooth(MutationsBZH.ppp, sigma = 500, weights = MutationsBZH.ppp$marks, eps = 100)
...
layoutLayer(title = "Prix moyen au m² de l'immobilier dans Rennes Métropole (2014-2019)", 
            author = "         Sources : IGN, DGFip - Rayon : 500 m\n         résolution : 1 ha - A partir des mutations", 
            scale = 5, frame = TRUE, col = "#cdd2d4", coltitle = "#8A5543", 
            north = TRUE, tabtitle = TRUE, horiz = FALSE)
...
for (i in ListAnnees){
  ...
  typoLayer(x = cartelissee.vecteur, var = "lyr.1", col = cols, lwd = 0.1,
...
barscale(lwd = 1.5, cex = 0.6, pos = "bottomright", style = "pretty", unit = "m")
cartography::north(pos = "topleft")

# Pour afficher le titre principal et la source
mtext("Prix moyen en Euros au m² des appartements à Rennes de 2014 à 2019", cex = 1, side = 3, line = 1, adj = 0.5, outer = TRUE)
mtext("   Sources : IGN et DGFip - Rayon de lissage : 500 m\n   et résolution : 1000 m²", side = 1, line = 1, adj = 0, cex = 0.6, outer = TRUE)
